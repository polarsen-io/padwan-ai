...
#   filename:  tmp.ogeXaaoewk.yml
#   timestamp: 2026-09-19T21:58:17+00:00
...
class CreateEmbeddingRequest(TypedDict):
...
class ModelResponseProperties(TypedDict):
    ...
    user: NotRequired[str]
    safety_identifier: NotRequired[str | None]
...
class FieldMisalignmentSteer(TypedDict):
    message: str
...
class ChatCompletionRequestMessageContentPartAudio(TypedDict):
    ...
    prompt_cache_breakpoint: NotRequired[PromptCacheBreakpointParam]
...
class MisalignmentErrorDetailsResource(TypedDict):
    ...
    detailed_explanation: NotRequired[str]
    steer: NotRequired[FieldMisalignmentSteer]


class PromptCacheOptionsParam(TypedDict):
    """
    ...
    ttl: NotRequired[Literal["30m"]]
    mode: NotRequired[Literal["implicit", "explicit"]]
...
class ModerationConfigParam(TypedDict):
    """
...
class CreateModelResponseProperties(ModelResponseProperties):
    prompt_cache_options: NotRequired[PromptCacheOptionsParam]
    top_logprobs: NotRequired[int | None]
...
class Error(TypedDict):
    ...
    param: str | None
    type: str
    misalignment: NotRequired[MisalignmentErrorDetailsResource]
...
class ModerationPolicyParam(TypedDict):
    """
    The policy to apply to moderated response input and output.
    """

    input: NotRequired[ModerationConfigParam | None]
    output: NotRequired[ModerationConfigParam | None]
...
class ChatCompletionModeration(TypedDict):
    ...
    input: ChatCompletionModerationResults | ChatCompletionModerationError
    output: ChatCompletionModerationResults | ChatCompletionModerationError


class ModerationParam(TypedDict):
    """
    Configuration for running moderation on the input and output of this response.
    """

    model: str
    policy: NotRequired[ModerationPolicyParam | None]
...
class CreateChatCompletionRequest(CreateModelResponseProperties):
    ...
    service_tier: NotRequired[
        Literal["auto", "default", "flex", "scale", "priority", "fast"] | None
    ]
    ...
    moderation: NotRequired[ModerationParam | None]
